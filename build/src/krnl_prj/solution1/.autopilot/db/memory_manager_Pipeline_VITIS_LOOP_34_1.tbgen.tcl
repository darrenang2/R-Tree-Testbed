set moduleName memory_manager_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {memory_manager_Pipeline_VITIS_LOOP_34_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ node_child int 32 regular {array 6 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "node_child", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	node_child { ap_memory {  { node_child_address0 mem_address 1 3 }  { node_child_ce0 mem_ce 1 1 }  { node_child_we0 mem_we 1 1 }  { node_child_d0 mem_din 1 32 } } }
}
set moduleName memory_manager_Pipeline_VITIS_LOOP_34_1
set isTopModule 0
set isCombinational 0
