...
#define XKRNL_CONTROL_ADDR_HBM_PTR_DATA                   0x10
#define XKRNL_CONTROL_BITS_HBM_PTR_DATA                   64
#define XKRNL_CONTROL_ADDR_OPERATIONS_DATA                0x1c
#define XKRNL_CONTROL_BITS_OPERATIONS_DATA                64
#define XKRNL_CONTROL_ADDR_PARAMETERS_FOR_OPERATIONS_DATA 0x28
#define XKRNL_CONTROL_BITS_PARAMETERS_FOR_OPERATIONS_DATA 64
#define XKRNL_CONTROL_ADDR_NUMBER_OF_OPERATIONS_DATA      0x34
#define XKRNL_CONTROL_BITS_NUMBER_OF_OPERATIONS_DATA      32
#define XKRNL_CONTROL_ADDR_BOARD_NUM_DATA                 0x3c
#define XKRNL_CONTROL_BITS_BOARD_NUM_DATA                 32
#define XKRNL_CONTROL_ADDR_EXE_DATA                       0x44
#define XKRNL_CONTROL_BITS_EXE_DATA                       32
